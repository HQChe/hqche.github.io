...
2. Che, H., Windows-Yule, K., O'Sullivan, C., & Seville, J. (2024). **A novel semi-resolved CFD-DEM method with two-grid mapping: Methodology and verification**. *AIChE Journal*, 70(2), e18321.

3. Che, H., Yue, Y., Liu, D., & Wang, S. (2025). **A Voronoi tessellation-based CFD-DEM porosity model for fluidized bed modelling**. *Advanced Powder Technology*, 36(7), 104913.

### Fluidized and Spouted Beds

1. Che, H., Al-Shemmeri, M., Fryer, P. J., Lopez-Quiroga, E., Wheldon, T. K., & Windows-Yule, K. (2023). **PEPT validated CFD-DEM model of aspherical particle motion in a spouted bed**. *Chemical Engineering Journal*, 453, 139689.

2. Che, H., Liu, D., Tian, W., Gao, S., Sun, J., & Xu, L. (2020). **CFD-DEM study of gas-solid flow regimes in a Wurster type fluidized bed with experimental validation by electrical capacitance tomography**. *Chemical Engineering Journal*, 389, 124280.

3. Che, H., Wang, H., Xu, L., & Ge, R. (2022). **Investigation of gas-solid heat and mass transfer in a Wurster coater using a scaled CFD-DEM model**. *Powder Technology*, 406, 117598.

4. Yue, Y., Zhao, W., Sun, X., Che, H., & Duan, R. (2024). **A CFD-DEM study of a two-joint spouting flow pattern in a multiple rectangular spout fluidized bed**. *Powder Technology*, 435, 119351.

5. Che, H., Wang, H., Xu, L., & Li, D. (2023). **Novel CFD-DEM model for spouted bed drying incorporating intraparticle heat and mass diffusion**. *Industrial & Engineering Chemistry Research*, 62(42), 17125–17134.
...
2. Che, H., Yue, Y., Jiang, Z., & Li, D. (2024). **Numerical investigation of transient gas-solid heat transfer in a packed bed: Impact of intra-particle thermal diffusion**. *Particuology*, 90, 404–411.
...
2. Liu, D., Che, H., Wang, C., & Chen, Y. (2025). **Assessing the effect of layered spatial variability on soil behavior via DEM simulation**. *Computational Particle Mechanics*, 12(1), 59–80.

3. Jiang, Z., Yue, K., Che, H., Oshitani, J., & Tsuji, T. (2025). **The drops of void fraction with increasing gas inflow velocity in reverse density segregation within a vibrated fluidized bed**. *Applied Thermal Engineering*, 272, 126409.
...
2. Sykes, J. A., Weston, D., Adio, N., Che, H., et al. (2025). **Validation of simulations of particulate, fluid and multiphase systems using positron emission particle tracking: A review**. *Particuology*, 101, 117–145.

3. Windows-Yule, K., Benyahia, S., Toson, P., Che, H., & Nicușan, A. L. (2025). **Numerical modelling and imaging of industrial-scale particulate systems: A review of contemporary challenges and solutions**. *KONA Powder and Particle Journal*, 42, 15–36.
